...
##### Base rasters
ecm <- raster("/home/tnaum/data/BLM_salinity/risk_index/ecave_mask.tif")
mask <- raster("/home/tnaum/data/BLM_salinity/water_mask/NLCD_water_mask.tif")

##### UCRB extent
ucrb_bnd <- readOGR("/home/tnaum/Dropbox/USGS/Utah_BLM_Salinity/Huc6_boundary", "CO_River_watershed_Meade", stringsAsFactors = F)

##### Agricultural lands Sources
agland <- readOGR("/home/tnaum/data/BLM_salinity/SPARROW/UCRB_Ag_Buto/sir2014_5039_UCRBAgriculture_v2.gdb", stringsAsFactors = F)
...
agIrrLandrast <- raster("/home/tnaum/data/BLM_salinity/DSM_SPARROW/inputs/IrrigAgrast.tif")
...
sar <- raster("/home/tnaum/data/BLM_Soils/SAR_2D_CV/Outputs/SAR_00cm_QRF_bt.tif")
...
rock <- raster("/home/tnaum/data/BLM_Soils/Rock_Frgmt_2D_CV/Outputs/wpg2_00cm_QRF.tif")
...
fs_vfs <- raster("/home/tnaum/data/BLM_Soils/FS_VFS_pct_2D_CV/Outputs/sand_f_vf_psa_00cm_QRF.tif")
fs_vfs_stk <- stack(fs_vfs,mask)
clusterR(fs_vfs_stk, overlay, args=list(fun=f_mask),progress='text', datatype='FLT4S', filename="/home/tnaum/data/BLM_salinity/DSM_SPARROW/inputs/fs_vfs_m.tif",options=c("COMPRESS=DEFLATE", "TFW=YES"))
ph <- raster("/home/tnaum/data/BLM_Soils/pH_h2o_2D_CV/Outputs/ph_h2o_2D_00cm_QRF.tif")
...
awc <- raster("/home/tnaum/data/BLM_Soils/Avail_H2O_2D_CV/w15l2/Outputs/w15l2_00cm_QRF.tif")
